...
static void chassis_init(chassis_move_t *chassis_move_init)
{
    ...
    //获取PC机的速度数据指针
    chassis_move_init->pc_vel = get_pc_cmd_vel_pointer();
...
static void chassis_mode_change_control_transit(chassis_move_t *chassis_move_transit)
{
    ...
    //切入辅助对位模式
    if ((chassis_move_transit->last_chassis_mode != CHASSIS_VECTOR_SUPPORT) && chassis_move_transit->chassis_mode == CHASSIS_VECTOR_SUPPORT)
    {
...
static void chassis_set_contorl(chassis_move_t *chassis_move_control)
{
    ...
    //辅助对位模式
    if (chassis_move_control->chassis_mode == CHASSIS_VECTOR_SUPPORT)
    {
