...
void chassis_behaviour_mode_set(chassis_move_t *chassis_move_mode)
{
    ...
    {
        chassis_behaviour_mode = CHASSIS_INFANTRY_SUPPORT;
    }
    ...
    else if (chassis_behaviour_mode == CHASSIS_INFANTRY_SUPPORT)
    {
        chassis_move_mode->chassis_mode = CHASSIS_VECTOR_SUPPORT; 
    }
...
void chassis_behaviour_control_set(fp32 *vx_set, fp32 *vy_set, fp32 *angle_set, chassis_move_t *chassis_move_rc_to_vector)
{
    ...
    {
        chassis_support_control(vx_set, vy_set, angle_set, chassis_move_rc_to_vector);
    }
    else if (chassis_behaviour_mode == CHASSIS_ENGINEER_FOLLOW_CHASSIS_YAW)
    {
...
static void chassis_no_follow_yaw_control(fp32 *vx_set, fp32 *vy_set, fp32 *wz_set, chassis_move_t *chassis_move_rc_to_vector)
{
    ...
    chassis_rc_to_control_vector(vx_set, vy_set, chassis_move_rc_to_vector);
    *wz_set = -CHASSIS_WZ_RC_SEN * chassis_move_rc_to_vector->chassis_RC->rc.ch[CHASSIS_WZ_CHANNEL]  - 0.05f * chassis_move_rc_to_vector->chassis_RC->mouse.x;
